...
/** Technician On The Way — ticket status timeline. Self-contained, no external assets. */
...
const STEPS: Step[] = [
  ...
  { id: "reached", title: "Reached", status: "pending" },
  { id: "work-in-progress", title: "Work In Progress", status: "pending" },
...
function TimelineNode({
  ...
  const lineColor = status === "pending" ? Colors.lineGray : Colors.green;
  return (
...
export default function TechnicianOnTheWayScreen() {
  return (
    <View style={styles.root} testID="technician-on-the-way-screen">
...
const styles = StyleSheet.create({
  ...
  stepTitlePending: { color: Colors.meta },
  stepMeta: { fontSize: 13, color: Colors.meta, marginTop: 4 },
  stepMetaActive: { color: Colors.green, fontWeight: "600" },
